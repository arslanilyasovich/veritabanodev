...
<?php
 ...
 extract($_SESSION); 
		...
		<?php
 include("config.php");
		  $stmt_edit = $DB_con->prepare("select sum(order_total) as total from orderdetails where user_id=:user_id and order_status='Spariş Verildi'");
...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="shop.php?id=1"> &nbsp; <span class='glyphicon glyphicon-shopping-cart'></span> Şimdi Alışveriş Yap</a></li>
 ...
 <form role="form" method="post" action="save_order.php">
    ...
    <div class="alert alert-default" style="color:white;background-color:#008CBA">
         <center><h3> <span class="glyphicon glyphicon-info-sign"></span> Sipariş detayları</h3></center>
        </div>
    ...
    <tr>
	 ...
	 <tr>
    	<td><label class="control-label">Fiyat</label></td>
    ...
    <tr>
        ...
        <td>
		 ...
		 <tr>
    	<td><label class="control-label">Miktar.</label></td>
    ...
    <tr>
        ...
        <a class="btn btn-danger" href="shop.php?id=1"> <span class="glyphicon glyphicon-backward"></span> İptal </a>
