	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if($imgFile)
		{
			...
			{			
				...
				{
					$errMSG = "Üzgünüz, dosyanız çok büyük, 5MB'den az olmalı";
					echo "<script>alert('Üzgünüz, dosyanız çok büyük, 5MB'den az olmalı')</script>";				
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
    	<td><label class="control-label">Ürün Adı.</label></td>
    ...
    <tr>
        ...
        <span class="glyphicon glyphicon-save"></span> Güncelleme
