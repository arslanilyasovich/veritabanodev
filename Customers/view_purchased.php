...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="view_purchased.php"> &nbsp; <span class='glyphicon glyphicon-eye-open'></span> Önceki Ürünler Sipariş Edildi</a></li>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="glyphicon glyphicon-eye-open"></span> Önceki Ürünler Sipariş Edildi</h3></center>
        </div>
				 ...
				 <form enctype="multipart/form-data" method="post" action="settings.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Password" name="user_password" type="şifre" value="<?php  echo $user_password; ?>" required>
