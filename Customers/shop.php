    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Bartın Market </a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li><a href="index.php"> &nbsp; <span class='glyphicon glyphicon-home'></span> Ana Sayfa</a></li>
					<li class="active"><a href="shop.php?id=1"> &nbsp; <span class='glyphicon glyphicon-shopping-cart'></span> Şimdi satın al</a></li>
					<li><a href="cart_items.php"> &nbsp; <span class='fa fa-cart-plus'></span> Alışveriş Sepeti Listeleri</a></li>
					...
					<li><a href="logout.php"> &nbsp; <span class='glyphicon glyphicon-off'></span> Çıkış</a></li>
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> Bu bizim kaykay stoklarımız, Şimdi alışveriş yapın!</h3></center>
        </div>
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<center><h4> Fiyat: ₺ ".$query2['item_price']." </h4></center>
		
					
										<a class='btn btn-block btn-danger' href='add_to_cart.php?cart=".$query2['item_id']."'><span class='glyphicon glyphicon-shopping-cart'></span> Sepete ekle</a>
            </div>
          </div>
        </div>";
...
if($id>1)
{
	echo "<li><a style='color:white;background-color : #033c73;' href='?id=".($id-1)."'>Önceki sayfa</a><li>";
}
if($id!=$total)
{
	echo "<li><a style='color:white;background-color : #033c73;' href='?id=".($id+1)."' class='pager'>Sonraki Sayfa</a></li>";
}
echo "</ul>";
				 ...
				 <form enctype="multipart/form-data" method="post" action="settings.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="İlk Adı" name="user_firstname" type="text" value="<?php  echo $user_firstname; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Soyadı" name="user_lastname" type="text" value="<?php  echo $user_lastname; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Şifre" name="user_password" type="password" value="<?php  echo $user_password; ?>" required>
