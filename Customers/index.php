    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Bartın Kaykay</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active"><a href="index.php"> &nbsp; <span class='glyphicon glyphicon-home'></span> Ana Sayfa</a></li>
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-info">
                        ...
                        &nbsp; &nbsp; Bartın Kaykay'a hoş geldiniz! Öyleyse, bir Element kaykay arıyorsanız, neden Bartın Kaykay'u ziyaret etmiyorsunuz?
            ...
            <div style="color:white;background-color:#008CBA" class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-block btn-success btn-md" name="user_save">Kaydet</button>
				 ...
				 <button type="button" class="btn btn-block btn-danger btn-md" data-dismiss="modal">İptal et</button>
