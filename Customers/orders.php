...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="orders.php"> &nbsp; <span class='glyphicon glyphicon-list-alt'></span> Sipariş ettiğim Ürünler</a></li>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="glyphicon glyphicon-list-alt"></span> Sipariş ettiğim Ürünler</h3></center>
        </div>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<td colspan='3' align='right'>Sipariş Edilen Toplam Fiyat:";
		echo "</td>";
