...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-danger">
                        ...
                        &nbsp; &nbsp; Bartın Kaykay MArket'a hoş geldiniz! Öyleyse, bir Element kaykay arıyorsanız, neden Bartın MArket'i ziyaret etmiyorsunuz?
Bu kadar kolay. Favori bir paten markanız varsa,
bu onu elde etmenin en kolay ve en basit yolu. Tek bir şeyle tanınan birçok paten markası,
güverteler gibi, ayrıca tamamlar
kamyonlar, rulmanlar vb. şeyler için diğer markalarla birlikte kendi özel tekerlekleri.
                    </div>
					<br />
          ...
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#008CBA" class="modal-content">
              ...
              <div class="modal-body">
				 ...
				 <form enctype="multipart/form-data" method="ilet" action="additems.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Ürün Adı:" name="item_name" type="text" required>
