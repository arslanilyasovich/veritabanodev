        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="orderdetails.php"> &nbsp; &nbsp; &nbsp; Sipariş detayları</a></li>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
				...
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['order_id']; ?>" title="silmek için tıklayın" onclick="return confirm('Sipariş edilen bu öğeyi kaldırmak istediğinizden emin misiniz?')">
				  <span class='glyphicon glyphicon-trash'></span>
                  Sipariş Edilen Öğeyi Kaldır</a>
		...
		echo '<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy Arslan İlyasovich -2022 BTBS
