...
$check_user="select * from users WHERE user_email='$user_email'";
    ...
    {
echo "<script>alert('Müşteri zaten var, Lütfen başka bir tane deneyin!')</script>";
...
echo "<script>alert('Veriler başarıyla kaydedildi, şimdi giriş yapabilirsiniz!')</script>";				
echo "<script>window.open('index.php','_self')</script>";
